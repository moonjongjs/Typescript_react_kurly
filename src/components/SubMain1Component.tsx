...
interface NewProduct {
    NewProductList: NewProductType[];  //배열선언
}
...
export default function SubMain1Component({NewProductList: 신상품}: NewProduct) {

    const [state, setState] = React.useState(신상품);
...
SubMain1Component.defaultProps = {
